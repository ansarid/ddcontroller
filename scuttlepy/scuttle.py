...
class SCUTTLE:
    ...
    def _wheelsLoop(self):
        ...
        while not self.stopped:
            ...
            self._loopTime = (time.monotonic_ns()-self._startTime)          # Calculate loop time

            # print(self._wait)
            # print(self._loopTime/1e6)
    ...
    #     self._timeFinal = time.monotonic_ns()
    ...
    #     self.wheelSpeeds = wheelIncrements / (timeIncrement/1e9)            # speed = distance/time
    ...
    def getDisplacement(self):                                              # store dispalcement info to the log var_AngularAndForwardDisplacements
        ...
        chassisIncrement = self.getChassis(self.leftWheel.getTravel(), self.rightWheel.getTravel())      # get latest chassis travel (m, rad)
        ...
        self._loopStart = time.monotonic_ns()                               # use for measuring loop time
